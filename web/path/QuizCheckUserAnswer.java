...
public class QuizCheckUserAnswer extends WebPage implements HTTPPath {
    ...
    public HTTPResponse processRequest(HTTPRequest request, Server server) {
        ...
        response.appendBody("<html><head><meta http-equiv='refresh' content='2;url=/quiz/" + quizID+ "/next-question' /></head><body><p>Redirecting you to the next question... </p></body></html>");
